...
public class NewCommandMacro {
	...
	MacroInfo.Commands.put(name, new MacroInfo("jlatexmath.NewCommandMacro", "executeMacro", nbargs));
    }
	...
	MacroInfo.Commands.put(name, new MacroInfo("jlatexmath.NewCommandMacro", "executeMacro", nbargs, 1));
    }
